        ...
        <div className="homePage-hero">
          ...
          {!userName || userName === 'null' ? 
            ...
            <div className="home-app-intro">
              ...
              <h2>Unbounded <b> Connections: </b>  Connect with anyone, anytime, easy and free video calls that make meetings better! <b> Video Conferencing!! </b></h2>
          ...
          <>
            <div className="home-app-intro">
                ...
                <h2>Unbounded Connections:  Connect with anyone, anytime, easy and free video calls that make meetings better! Video Conferencing!!</h2>
            </div>
            <div className="home-meet-container">
              <div className="create-meet">
                ...
                <button  data-bs-toggle="modal" data-bs-target="#staticBackdrop" style={{ backgroundColor: '#FF007F', color: 'white' }}><RiVideoAddFill/> New meet</button>
              </div>
              <p>or</p>
              <div className="join-meet">
                <input type="text" placeholder='Enter code...' onChange={(e)=> setJoinRoomId(e.target.value)} />
                <button onClick={handleJoinRoom}style={{ backgroundColor: 'red', color: 'white' }} > <CgEnter /> Join Meet</button>
              </div>
            </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <select class="form-select" aria-label="Default select example" onChange={(e) => setNewMeetType(e.target.value)}>
                      ...
                      <option value="instant">Immediate meet</option>
